      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800 rounded-2xl p-8 shadow-2xl border border-slate-700">
          ...
          <p className="text-slate-400 text-sm text-center mb-8">
            Dành cho nhân viên nội bộ Nedu
          </p>

          <button
            onClick={handleGoogleLogin}
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 disabled:opacity-60 text-gray-800 font-medium py-3 px-4 rounded-xl transition-colors"
          >
            {loading ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-500 text-xs">
              Chỉ tài khoản @nedu.vn mới có thể đăng nhập
            </p>
          </div>
        </div>

        <p className="text-center text-slate-600 text-xs mt-6">
          © 2026 Nedu Education. All rights reserved.
        </p>
      </div>
    </div>
  );
